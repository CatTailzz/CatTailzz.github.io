(() => {
  // ns-hugo:/Users/CatTail/Documents/Project/CatTail/themes/FixIt/assets/js/util.js
  var Util = class {
      ...
      this.util.forEach(document.querySelectorAll(".highlight > .chroma:not([data-init])"), ($chroma) => {
        ...
        if ($codeElements.length) {
          ...
          if (this.config.code.copyTitle) {
            ...
            $copy2.insertAdjacentHTML("afterbegin", '<i class="fa-regular fa-copy fa-fw" aria-hidden="true"></i>');
            $copy2.classList.add("copy");
            const code = $code.innerText.trim();
            if (this.config.code.maxShownLines < 0 || code.split("\n").length < this.config.code.maxShownLines + 2) {
              $chroma.classList.add("open");
            }
            $copy2.title = this.config.code.copyTitle;
